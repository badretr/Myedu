...
urlpatterns = [
    ...
    path("mon-emploi-du-temps/", views.teacher_schedule, name="teacher_schedule"),
    ...
    path("cahier-de-textes/administration/", views.lessons_admin, name="lessons_admin"),
    path("mes-classes/<int:classroom_pk>/ressources/", views.teacher_resources, name="teacher_resources"),
    path("ressources/", views.my_resources, name="my_resources"),
